...
class TestImportantQuestions:
    ...
    def test_important_questions(function_name, expected_elements):
        important_questions = ImportantQuestions(driver)
        important_questions.go_to_site()
        important_questions.function_name
        assert important_questions.find_element(expected_elements)
