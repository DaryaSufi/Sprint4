...
class TestOrderPage:
    ...
    def test_open_form_for_order(self,driver):
        ...
        assert order_page.find_element(OrderPageLocators.name_input_field)
    ...
    def test_fill_form_about_rent(self, driver, data_1):
        order_page = OrderPage(driver)
        order_page.fill_form_about_rent(data_1['when_to_bring_the_scooter'], data_1['rental_period_locator'], data_1['checkbox_locator'], data_1['metro_name_locator'],data_1['comment'])
    ...
    def test_logo_yandex_click(self,driver):
        ...
        assert order_page.current_url == Constants.URL_DZEN
